  ...
  return (
    ...
    <section className='py-5 bg-light'>
        <div className="container">
            <h4 className='fw-bold my-5 what-title'>Laser and Routers</h4>
            <OwlCarousel className='owl-theme px-2' {...slider}>
                {laserrouterData.map((a) => (
            ...
            <button className='readmore-button what-title1 p-2 d-flex align-items-center gap-3 my-3'><Link to="laser-routers">View More <i className="fa-solid fa-arrow-right"></i></Link></button>
        </div>
    </section>
</>
  )
}
export default LaserRouters
