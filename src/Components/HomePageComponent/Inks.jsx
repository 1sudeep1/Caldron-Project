        ...
        <>
            <section className='py-5'>
                <div className="container">
                    ...
                    <button className='readmore-button what-title1 p-2 d-flex align-items-center gap-3 my-3'><Link to="/inksProduct">View More <i className="fa-solid fa-arrow-right"></i></Link></button>
                </div>
            </section>
        </>
    )
